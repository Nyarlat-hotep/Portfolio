  ...
  return (
    <div className="hud-frame" aria-hidden="true">
      ...
      <svg className="hud-tc2" viewBox="0 0 240 18" xmlns="http://www.w3.org/2000/svg">
        <line x1="10" y1="9" x2="230" y2="9" stroke="rgba(255,119,0,0.65)" strokeWidth="1"/>
        <rect x="44"  y="4" width="10" height="10" fill="rgba(255,119,0,0.65)" rx="1"/>
        <rect x="92"  y="4" width="10" height="10" fill="rgba(255,119,0,0.48)" rx="1"/>
        <rect x="120" y="4" width="10" height="10" fill="rgba(255,119,0,0.32)" rx="1"/>
        <rect x="148" y="4" width="10" height="10" fill="rgba(255,119,0,0.48)" rx="1"/>
        <rect x="196" y="4" width="10" height="10" fill="rgba(255,119,0,0.65)" rx="1"/>
        <circle cx="10"  cy="9" r="2" fill="rgba(255,119,0,0.44)"/>
        <circle cx="230" cy="9" r="2" fill="rgba(255,119,0,0.44)"/>
      </svg>
